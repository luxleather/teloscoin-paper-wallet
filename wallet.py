...
class Keys:
    ...
    def privatekeywif(self):
        prefix = b'\x62' # x62 Teloscoin WIF prefix '4'
    ...
    def publicaddress(self):
        prefix_a = b'\x04'
        prefix_b = b'\x26' # Teloscoin bytes x26 with start letter 'G'
